...
const handlers = [
    http.get('https://github.com/chinmayp916/angular-certificate-test/options/:id', ({ params }) => {
        const options = {
            S: {
                configs: [
                    {
    ...
    http.get('https://github.com/chinmayp916/angular-certificate-test/models', ({ request, params, cookies }) => {
